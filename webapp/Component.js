			...
			$.when(promise1).done(
				function () {
					...
					if (ExistingModel === null || ExistingModel === undefined ||(ExistingModel && ExistingModel.getData() === null)) {
						...
						var ntID =  aData.employeeDetail.ZZ_DEP_NTID;
						...
						var batchOperation25 = oDataModel.createBatchOperation("FioriAuthTileDisplay/?UserID='"+ntID+"'", "GET");
						oDataModel.addBatchReadOperations([batchOperation0, batchOperation1, batchOperation2, batchOperation3,
							batchOperation5, batchOperation6, batchOperation7, batchOperation17, batchOperation24, batchOperation4,batchOperation25
						]);
						oDataModel.submitBatch(function (oResult) {
							...
							// Adding app role
							try{
								globalData.AppTyp = oResult.__batchResponses[10].data.results[0].AppTyp;
							}catch(err){
								globalData.AppTyp = "";
							}
