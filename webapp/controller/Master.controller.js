...
], function (JSONModel, BaseController, Filter, FilterOperator, Sorter, MessageBox, formatter, Common) {
	"use strict";

	return BaseController.extend("com.bosch.hr.swift_trv.controller.Master", {
		formatter: formatter,
		onInit: function () {
					...
					onClose: function (sAction) {
						if (sAction === "OK") {
							...
							that.getOwnerComponent().getHelper().then(function (oHelper) {
								...
								that.oRouter._oRoutes.detail._oConfig.layout = "TwoColumnsMidExpanded";
